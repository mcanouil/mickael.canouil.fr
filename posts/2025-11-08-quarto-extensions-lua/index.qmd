...
description: |
  Elevate your Quarto extension development with proven patterns and best practices.

  Quarto extensions unlock powerful customisation capabilities, but turning working code into maintainable, robust extensions requires more than just functionality.
  This guide explores essential practices drawn from the Quarto core team's extensions and community standards, covering project structure, error handling, documentation, and release management to help transform your extensions into reliable, community-friendly tools that stand the test of time.
date: "2025-11-08"
categories:
  - quarto
  - extensions
...
This guide presents opinionated recommendations based on patterns observed in successful Quarto extensions and general software development best practices.
