...
For example, I create a website using the Quarto CLI and add a code cell to the `about.qmd` file that uses the `palmerpenguins` {{< iconify fa6-brands r-project >}} package.  
