...
Under a custom `mcanouil-typst` format, only `mcanouil-typst:` matches, not `typst:`, and the built-in PDF format is targeted with `pdf:`, since that is the format name Quarto requests, not the writer it happens to use underneath.
