...
Both project types produce a Typst PDF and an HTML output.
The PDF comes out much the same either way, 50 pages in both, so the project type hardly shows there.
The HTML is where it shows, and the book is the one to use.
...
The single document puts the whole report on one page, 850 kB of it, against 140 kB for the chapter that holds the same tables.
