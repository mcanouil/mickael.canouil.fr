...
image: featured.gif
image-alt: |
  Animated feature image cycling through six brand configurations, each showing
  branded scatter plots and tables in light and dark modes using Quarto's brand
  feature with ggplot2 and gt in R.
---
...
Quarto's `brand` feature themes your document automatically, but code-generated figures and tables need explicit styling.
This post shows how to read brand colours, fonts, and palettes from the `QUARTO_EXECUTE_INFO` environment variable at render time, then apply them to:

- `ggplot2` and `plotnine` figures via a custom `theme_brand()` function.
- `gt` and `great_tables` tables via a custom `gt_brand()` function.

The companion repository [mcanouil/quarto-brand-renderings](https://github.com/mcanouil/quarto-brand-renderings) contains six complete brand configurations with parallel R and Python implementations.

:::

## The Problem

Quarto's `brand` feature lets you define colours, fonts, and logos in a single configuration.
The document theme, navbar, sidebar, and code blocks all pick up these values automatically.

Code-generated figures and tables, however, do not.
A `ggplot2` scatter plot or a gt summary table will use their default styling regardless of what your brand specifies.
...
- [`pyfonts`](https://github.com/y-sunflower/pyfonts): font loading from Bunny Fonts and Google Fonts, created by Joseph Barbier.
...
The [companion repository](https://github.com/mcanouil/quarto-brand-renderings) contains production-ready versions with full error handling, defensive `.get()` fallbacks, and additional styling such as continuous palette support in R.
...
The `gt_brand()` function applies brand colours and fonts to `gt` (R) and `great_tables` (Python) tables.
...
A `configure_brand_fonts()` function, called once at setup, registers each font before any plots or tables are created.
...
See the [companion repository](https://github.com/mcanouil/quarto-brand-renderings) for the full implementation.
...
```{=html}
<style>
#branded-carousel .carousel-control-prev-icon,
#branded-carousel .carousel-control-next-icon {
  filter: drop-shadow(0 0 4px rgba(0,0,0,0.6)) drop-shadow(0 0 1px rgba(0,0,0,0.8));
}
#branded-carousel .carousel-indicators button {
  box-shadow: 0 0 4px rgba(0,0,0,0.6), 0 0 1px rgba(0,0,0,0.8);
}
#branded-carousel {
  max-width: 500px;
  width: 100%;
...
<div id="branded-carousel" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#branded-carousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Brand 1"></button>
    <button type="button" data-bs-target="#branded-carousel" data-bs-slide-to="1" aria-label="Brand 2"></button>
    <button type="button" data-bs-target="#branded-carousel" data-bs-slide-to="2" aria-label="Brand 3"></button>
    <button type="button" data-bs-target="#branded-carousel" data-bs-slide-to="3" aria-label="Brand 4"></button>
    <button type="button" data-bs-target="#branded-carousel" data-bs-slide-to="4" aria-label="Brand 5"></button>
    <button type="button" data-bs-target="#branded-carousel" data-bs-slide-to="5" aria-label="Brand 6"></button>
  </div>
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/_featured-brand-1.png" class="d-block w-100" alt="Brand 1 featured image showing light and dark mode branded figures and tables.">
    </div>
    <div class="carousel-item">
      <img src="assets/_featured-brand-2.png" class="d-block w-100" alt="Brand 2 featured image showing light and dark mode branded figures and tables.">
    </div>
    <div class="carousel-item">
      <img src="assets/_featured-brand-3.png" class="d-block w-100" alt="Brand 3 featured image showing light and dark mode branded figures and tables.">
    </div>
    <div class="carousel-item">
      <img src="assets/_featured-brand-4.png" class="d-block w-100" alt="Brand 4 featured image showing light and dark mode branded figures and tables.">
    </div>
    <div class="carousel-item">
      <img src="assets/_featured-brand-5.png" class="d-block w-100" alt="Brand 5 featured image showing light and dark mode branded figures and tables.">
    </div>
    <div class="carousel-item">
      <img src="assets/_featured-brand-6.png" class="d-block w-100" alt="Brand 6 featured image showing light and dark mode branded figures and tables.">
    </div>
  </div>
  <button class="carousel-control-prev" type="button" data-bs-target="#branded-carousel" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class="carousel-control-next" type="button" data-bs-target="#branded-carousel" data-bs-slide="next">
...
The companion repository [mcanouil/quarto-brand-renderings](https://github.com/mcanouil/quarto-brand-renderings) contains six brand configurations with full R and Python implementations for branded figures and tables.
Browse the rendered examples to see how different colour palettes and typography affect the overall look and feel.
