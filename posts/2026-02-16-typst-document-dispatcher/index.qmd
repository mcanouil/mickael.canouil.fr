...
categories:
  ...
  - pdf
image: featured.png
image-alt: "Diagram showing a dispatcher routing to different document templates."
lang: en-GB
...
It provides the foundation for Pandoc features like callouts.

:::

### Overriding Partials

Extensions override default partials by providing replacement files via `template-partials` in `_extension.yml`.
