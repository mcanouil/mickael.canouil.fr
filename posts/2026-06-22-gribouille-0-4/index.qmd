...
description: |
  Gribouille 0.4.0 teaches the scales to read dates and times from plain
  strings, lets any character stand in as a point marker, and splits the
  panel grid into a major and minor cascade with minor gridlines on by
  default. It also renames labs() to labels(), and closes with a real chart
  built from the package's own GitHub star history.
date: "2026-06-22"
categories:
  - typst
  - quarto
