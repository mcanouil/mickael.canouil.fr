...
**{{< meta quarto-wizard >}} Quarto Wizard 2.0.0** is here with a major architectural overhaul and new features for managing your Quarto extensions.
...
The result is a more self-contained extension.
...
A new documentation website is now available at [m.canouil.dev/quarto-wizard](https://m.canouil.dev/quarto-wizard), featuring:
...
Next on the roadmap: a new version of the [Quarto Extensions Updater GitHub Action](https://github.com/mcanouil/quarto-extensions-updater) that will use this core package, bringing the same native installation capabilities to your CI/CD workflows.
