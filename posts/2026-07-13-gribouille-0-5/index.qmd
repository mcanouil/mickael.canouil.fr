...
## Stricter Errors and Rendering Fixes
...
An unknown `aes()` aesthetic, such as the US spelling `color`, now fails with the list of valid aesthetics instead of drawing an empty plot.
