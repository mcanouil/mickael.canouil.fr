...
```{.lua filename="Without factories"}
local DIV_HANDLERS = {
...
local function get_builtin_mappings()
  return {
    div = { -- <1>
      ...
      ['panel'] = { wrapper = 'panel', arguments = true }, -- <3>
...
1. Load the shared wrapper module using Quarto's path resolution (see [Module Loading](#module-loading)).
