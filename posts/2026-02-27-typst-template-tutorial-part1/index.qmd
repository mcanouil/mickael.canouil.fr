...
1. Here, colours are hard-coded for simplicity; in a production extension you could retrieve them from `_brand.yml` using the Quarto Brand Lua API (see @nte-brand-lua).
...
```{.lua filename="_extensions/my-extension/wrapper.lua"}
