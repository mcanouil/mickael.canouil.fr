...
Upload `carousel.pdf` to LinkedIn as a document post, or use the PNG frames if you want a preview or a GIF.
...
Then tell me the two `typst compile` commands to export it to PDF and to one PNG
per page.
