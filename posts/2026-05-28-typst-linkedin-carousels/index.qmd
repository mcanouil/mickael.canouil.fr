...
extensions:
  typst-render:
    ...
    classes: "hero-art w-50 mx-auto d-block"
    cache: false
---
...
The [LinkedIn image size guide](https://www.linkedin.com/pulse/linkedin-image-size-guide-2026-jan-van-musscher-wslwe/) recommends carousels as a square 1080 by 1080, or a 4:5 portrait.
...
For convenience, I keep the page geometry, a small palette, the fonts, and the `slide` layout in a shared preamble file.
...
![](assets/carousel/carousel.gif){.hero-art .img-fluid .w-50 .mx-auto .d-block fig-align="center" fig-alt="A looping GIF cycling through three square carousel cards: the cover 'Build decks from text', a 'Three reasons it fits carousels' list, and a dark closing 'Compile and post.' card, each with the emerald rail and a page number."}
