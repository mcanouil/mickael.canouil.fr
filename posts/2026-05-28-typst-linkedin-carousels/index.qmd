...
![](assets/carousel/carousel.gif){.img-fluid .w-50 .mx-auto .d-block .rounded-3 .border fig-align="center" fig-alt="A looping GIF cycling through three square carousel cards: the cover 'Build decks from text', a 'Three reasons it fits carousels' list, and a dark closing 'Compile and post.' card, each with the emerald rail and a page number."}
