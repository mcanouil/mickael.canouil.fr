...
<img src="media/tweet-1.png" alt="Tweet: Maybe I went too far with ggplot2 and gganimate ... 😅 What do you \@hadleywickham & \@thomasp85, did I go too far or not enough ? (I am planning to add the ghosts 😎) followed by an GIF of a PacMan moving in a labyrinth" style="position: static; visibility: visible; width: 550px; height: 821px; display: inline-block; flex-grow: 1; padding: 10px; text-align: center;"/>
...
<img src="media/tweet-2.png" alt="Tweet: Next mission, should you choose to accept, is to make Pac-Man face the direction of movement &mdash; Thomas Lin Pedersen (\@thomasp85)" style="position: static; visibility: visible; width: 550px; height: 327px; display: inline-block; flex-grow: 1; padding: 10px; text-align: center;"/>
