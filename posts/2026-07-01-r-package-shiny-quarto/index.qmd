...
My day job is to conduct statistical analysis of omics data, and most of it is spent writing R code through packages, Shiny apps, and scripts.
These are used by everyone from data scientists to clinicians who never open a terminal.
...
Inside `mod_analysis`, the call is:
