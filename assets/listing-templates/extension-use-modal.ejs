```{=html}
<!-- <button type="button" class="btn btn-outline-light" style="text-align: center;" data-bs-toggle="modal" data-bs-target="#useModal-<%= id %>">Use Template</button> -->
<div class="modal fade" id="useModal-<%= id %>" tabindex="-1" aria-labelledby="useModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title no-anchor" id="useModalLabel">Use Options</h5>
...
{{< iconify octicon:terminal title="Terminal Icon" label="Terminal Icon" >}} Manually
:::
...
:::: {.fw-bold style="text-align: left;"}
{{< iconify octicon:cloud-download title="Cloud Download Icon" label="Cloud Download Icon" >}} Using Quarto Wizard
:::

```{=html}
            <div class="btn-group" role="group" aria-label="Quarto Wizard extension template installer options">
              <button
                type="button"
